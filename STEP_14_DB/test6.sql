...
values(1,'aaa','kim','010-1111-1111','서울',75,100,'2010-08-01','Y');
--- 무결성 제약조건 위배 : id1 중복

insert into user1(idx,id,name,phone,address,score,subject_code,hire_date,marriage)
values(2,'aaa','kim','010-1111-1111','서울',75,100,'2010-08-01','Y');
--- 무결성 제약조건 위배 : id 'aaa'중복

insert into user1(idx,id,name,phone,address,score,subject_code,hire_date,marriage)
values(2,'bbb','010-1111-1111','서울',75,100,'2010-08-01','Y');
--- 값의 개수가 일치 하지 않음

insert into user1(idx,id,name,phone,address,score,subject_code,hire_date,marriage)
values(2,'bbb','lee','010-1111-1111','서울',175,100,'2010-08-01','Y');
--- 체크 제약조건 위배 : 값의 범위가 일치 하지 않은 175

insert into user1(idx,id,name,phone,address,score,subject_code,hire_date,marriage)
values(2,'bbb','lee','010-1111-1111','서울',75,100,'2010-08-01','K');
--- 체크 제약조건 위배 : 값의 범위가 일치 하지 않은 K

insert into user1(idx,id,name,phone,address,score,subject_code,hire_date,marriage)
values(2,'bbb','lee','010-1111-1111','서울',75,100,'2010-08-01','N');
...
flashback table user3 to before drop; -- 삭제된 파일 복구, 단 이클립스는 휴지통 비우기로 인해 복구 불가능
...
select idx_sql.nextval from dual;--현재 적용하고자 하는 번호에 사용
select idx_sql.currval from dual;--현재 시퀀스의 값
...
insert into dept(deptno,dname) values (10,'강호동');
insert into dept(deptno,dname) values (20,'아이유');
insert into dept(deptno,dname) values (30,'고소영');
insert into dept(deptno,dname) values (40,'이효리');
insert into dept(deptno,dname) values (50,'장동건');
select * from dept;

insert into emp(empno,ename,deptno) values (100,'강호동',10);
insert into emp(empno,ename,deptno) values (101,'아이유',20);
insert into emp(empno,ename,deptno) values (102,'유재석',50);-- 에러 부모키 X

insert into emp(empno,ename,deptno) values (103,'이효리',40);
insert into emp(empno,ename) values (105,'장동건');
insert into emp(empno,ename,deptno) values ('고소영',30); -- 에러 기본키에 null 허용 X
commit
select * from emp;
--ex25) 삭제
